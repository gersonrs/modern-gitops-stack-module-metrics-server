...
resource "argocd_project" "this" {
  ...
  spec {
    ...
    source_repos = ["https://github.com/GersonRS/modern-gitops-stack-module-metrics-server.git"]
...
resource "argocd_application" "this" {
  ...
  spec {
    ...
    source {
      repo_url        = "https://github.com/GersonRS/modern-gitops-stack-module-metrics-server.git"
